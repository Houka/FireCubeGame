...
#pragma mark Constructors
	...
	*/
	EnemyModel(void) : BoxObstacle(), _drawscale(1.0f), _mainCycle(false), _leftCycle(false), _rghtCycle(false) { }
...
#pragma mark Static Constructors
	...
	* @return a newly allocated rocket with the given position
	*/
	static std::shared_ptr<EnemyModel> alloc(const cugl::Vec2& pos, const cugl::Size& size) {
		std::shared_ptr<EnemyModel> result = std::make_shared<EnemyModel>();
