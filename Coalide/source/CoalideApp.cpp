...
void CoalideApp::update(float timestep) {
    std::string levelNames[6] = {"json/levels/lvl2E.json", "json/klvls/klvl2.json", "json/klvls/klvl3.json", "json/openBetaJsons/lvl4.json", "json/lvl0.json", "json/openBetaJsons/lvl6.json"};
